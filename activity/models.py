...
class Activity(models.Model):
    ...
    activity_price = models.IntergerField(max_length=10, verbose_name='活动价格',blank=False, null=False)
...
class Apply(models.Model):
    ...
    user_id = models.IntergerField(max_length=8, verbose_name='用户id', blank=True, null=True, editable=False)
    activity_id = models.IntgererField(max_length=8, verbose_name='活动id', blank=True, null=True, editable=False)
    train_id = models.IntergerField(max_length=8, verbose_name='培训id', blank=True, null=True,editable = False)
