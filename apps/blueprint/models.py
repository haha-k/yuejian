...
class Blueprint(models.Model):
    ...
    user = models.ForeignKey(Account,on_delete=models.SET_NULL,verbose_name='用户id',null=True,db_column='user_id')
...
class Picture(models.Model):
    ...
    url = models.ImageField(verbose_name="图片地址",upload_to = './static/images/%Y/%m/%d',null=False,blank=False,)
    create_time = models.DateTimeField(verbose_name='创建时间',auto_now_add=True)
    update_date = models.DateTimeField(verbose_name='更新日期', auto_now=True)
    user = models.ForeignKey(Account,verbose_name='上传用户',on_delete='SET_NULL')
